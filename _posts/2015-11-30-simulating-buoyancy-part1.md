...
With that, I hope I have provided the motivation for why we're interested in finding the volume of a unit cube below a plane: Because video games.  We've done the physics.  We've made our approximations and assumptions.  We only have the math left to do.
